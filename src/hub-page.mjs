...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    @media(max-width:760px){.shell{width:min(100% - 20px,1180px);padding-top:24px}.topbar{display:block}.actions{justify-content:flex-start;margin-top:18px}.overview{grid-template-columns:repeat(2,1fr)}.grid{grid-template-columns:1fr}.toolbar{align-items:flex-end}.sync{display:none}.card-foot{flex-wrap:wrap}.source{width:100%}.card-actions{width:100%;justify-content:flex-end}.method-fields{grid-template-columns:1fr}.method-row.wide{grid-column:auto}.method-head,.method-body{padding-left:16px;padding-right:16px}}
