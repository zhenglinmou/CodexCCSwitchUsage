...
$payloadFiles = @(
    ...
    'src\usage-client.mjs', 'src\cdp-client.mjs', 'src\cdp-disconnect-guard.mjs', 'src\injector-script.mjs',
    'src\edge-session.mjs', 'src\hub-provider-adapters.mjs', 'src\hub-service.mjs',
    'src\hub-page.mjs', 'src\hub-server.mjs',
    'src\target-session.mjs', 'src\target-discovery.mjs', 'src\host.mjs',
