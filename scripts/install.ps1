...
$files = @(
    ...
    'src\usage-client.mjs', 'src\cdp-client.mjs', 'src\browser-callback-broker.mjs', 'src\hub-provider-adapters.mjs', 'src\provider-request-usage.mjs', 'src\provider-templates.mjs',
